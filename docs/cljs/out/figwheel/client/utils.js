...
return (new CustomEvent(event_name,(function (){var obj25245 = {"detail":data};
return obj25245;
})()));
} else {
...
var f = (function (){var pred__25252 = cljs.core._EQ_;
var expr__25253 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25252.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25253))){
return ((function (pred__25252,expr__25253){
return (function (p1__25246_SHARP_){
return console.warn(p1__25246_SHARP_);
});
;})(pred__25252,expr__25253))
} else {
if(cljs.core.truth_(pred__25252.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25253))){
return ((function (pred__25252,expr__25253){
return (function (p1__25247_SHARP_){
return console.debug(p1__25247_SHARP_);
});
;})(pred__25252,expr__25253))
} else {
if(cljs.core.truth_(pred__25252.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25253))){
return ((function (pred__25252,expr__25253){
return (function (p1__25248_SHARP_){
return console.error(p1__25248_SHARP_);
});
;})(pred__25252,expr__25253))
} else {
return ((function (pred__25252,expr__25253){
return (function (p1__25249_SHARP_){
return console.log(p1__25249_SHARP_);
});
;})(pred__25252,expr__25253))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25256){
...
var eval_fn = cljs.core.get.call(null,map__25257__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25259_SHARP_);
});})(new_def))
);
...
return (function (p__25260){
var vec__25261 = p__25260;
var ky = cljs.core.nth.call(null,vec__25261,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1532458882913
