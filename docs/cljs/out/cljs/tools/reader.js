...
var G__13091 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__13091;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__13092 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__13092,ch);
...
if(("\\" === ch__$1)){
var ch_13093__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_13093__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_13093__$2);
} else {
}
...
var vec__13102 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__13102,(0),null);
var start_column = cljs.core.nth.call(null,vec__13102,(1),null);
...
var G__13105 = cljs.core.conj_BANG_.call(null,a,form);
a = G__13105;
continue;
}
}
...
var _STAR_read_delim_STAR_13106 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_13106;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__13107 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__13107,(0),null);
var start_column = cljs.core.nth.call(null,vec__13107,(1),null);
...
var vec__13110 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__13110,(0),null);
var end_column = cljs.core.nth.call(null,vec__13110,(1),null);
...
var vec__13116 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__13116,(0),null);
var end_column = cljs.core.nth.call(null,vec__13116,(1),null);
...
var vec__13119 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__13119,(0),null);
var start_column = cljs.core.nth.call(null,vec__13119,(1),null);
...
var vec__13122 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__13122,(0),null);
var end_column = cljs.core.nth.call(null,vec__13122,(1),null);
...
var sb = (function (){var G__13125 = (new goog.string.StringBuffer());
G__13125.append(initch);
...
var G__13127 = (function (){var G__13126 = sb;
G__13126.append(ch);

return G__13126;
})();
var G__13128 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__13127;
ch = G__13128;
continue;
}
...
switch (G__13131) {
case "\\":
var G__13135 = (function (){var G__13132 = sb;
G__13132.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__13132;
})();
var G__13136 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__13135;
ch = G__13136;
continue;
...
break;
default:
var G__13137 = (function (){var G__13133 = sb;
G__13133.append(ch);

return G__13133;
})();
var G__13138 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__13137;
ch = G__13138;
continue;
...
var vec__13139 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__13139,(0),null);
var end_column = cljs.core.nth.call(null,vec__13139,(1),null);
...
var line = cljs.core.nth.call(null,vec__13142,(0),null);
var column = cljs.core.nth.call(null,vec__13142,(1),null);
...
var vec__13147 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__13147,(0),null);
var column = cljs.core.nth.call(null,vec__13147,(1),null);
...
var vec__13152 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__13152,(0),null);
var column = cljs.core.nth.call(null,vec__13152,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__13157 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__13157,(0),null);
var start_column = cljs.core.nth.call(null,vec__13157,(1),null);
...
var vec__13160 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__13160,(0),null);
var end_column = cljs.core.nth.call(null,vec__13160,(1),null);
...
var G__13163 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__13163,true,null,opts,pending_forms);
...
var G__13164 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__13164)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__13164)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__13164)){
...
var _STAR_suppress_read_STAR_13165 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_13165;
}});
...
var G__13166 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__13166,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__13166,rdr,first_line);
...
var G__13170 = matched;
var G__13171 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__13170;
finished = G__13171;
continue;
} else {
...
var _STAR_suppress_read_STAR_13172 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_13172;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env13173 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__13174 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__13174,"(");
...
var G__13175 = (i + (1));
var G__13176 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env13173;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__13177 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__13177);
...
var G__13178 = cljs.core.next.call(null,s__$1);
var G__13179 = ret;
s__$1 = G__13178;
r = G__13179;
continue;
...
var G__13180 = cljs.core.next.call(null,s);
var G__13181 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__13180;
key_vals = G__13181;
continue;
} else {
...
var gensym_env13185 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env13185;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__13186 = token;
var G__13186__$1 = (((G__13186 == null))?null:cljs.core.subs.call(null,G__13186,(1)));
var G__13186__$2 = (((G__13186__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__13186__$1));
var G__13186__$3 = (((G__13186__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__13186__$2));
var G__13186__$4 = (((G__13186__$3 == null))?null:cljs.core.symbol.call(null,G__13186__$3));
if((G__13186__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__13186__$4);
}
})():(function (){var G__13187 = token;
var G__13187__$1 = (((G__13187 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__13187));
if((G__13187__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__13187__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e13194){if((e13194 instanceof Error)){
var e = e13194;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__13198,reader){
...
var opts = map__13199__$1;
var eof = cljs.core.get.call(null,map__13199__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___13207 = arguments.length;
var i__4532__auto___13208 = (0);
while(true){
if((i__4532__auto___13208 < len__4531__auto___13207)){
args__4534__auto__.push((arguments[i__4532__auto___13208]));

var G__13209 = (i__4532__auto___13208 + (1));
i__4532__auto___13208 = G__13209;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq13205){
var G__13206 = cljs.core.first.call(null,seq13205);
var seq13205__$1 = cljs.core.next.call(null,seq13205);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13206,seq13205__$1);
});
